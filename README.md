...
Every PR is also analysed on [SonarCloud](https://sonarcloud.io/organizations/propensi-ppl-tofly)
(one project per app); a failed quality gate blocks the deploy. See `.github/ci-cd.md` §9.

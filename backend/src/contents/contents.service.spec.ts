...
describe('ContentsService', () => {
  ...
  describe('assignManualSlot', () => {
    it('updates content deadline to the assigned date', async () => {
      prisma.contents.findUnique.mockResolvedValue({
        id: 'content-1',
      ...
      prisma.contents.update.mockResolvedValue({
        id: 'content-1',
        deadline: day(20),
      });
    ...
    it('throws CONTENT_NOT_FOUND for nonexistent content', async () => {
      prisma.contents.findUnique.mockResolvedValue(null);
    ...
    it('returns updated content with new deadline', async () => {
      ...
      prisma.contents.update.mockResolvedValue(updated);

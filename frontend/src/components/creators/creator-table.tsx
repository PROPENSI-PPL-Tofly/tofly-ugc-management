...
export function CreatorTable({
    ...
    const [selectedCreator, setSelectedCreator] =
        useState<CreatorSummary | null>(null);
                        ...
                        >
                                ...
                                {creator.contract.status === "none" ? (
                                    ...
                                    <>
                                        <p className="mt-1 whitespace-nowrap">
                                            {formatContractWindow(
                                                creator.contract.startDate,
                                                creator.contract.endDate,
                                            )}
                                        </p>

                                        <p className="text-xs text-muted">
                                            {contractNote(creator)}
                                        </p>
                                    </>
                                )}
                            </td>
                            ...
                            <td className={CELL}>
                                <p className="whitespace-nowrap">
                                    {creator.progress.submitted}/
                                    {creator.progress.total} konten terkirim
                                </p>
                            ...
                            <td className={CELL}>
                                <Pill
                                    tone={
                                        PRODUCTIVITY_TONES[
                                            creator.performance.productivity
                                            ]
                                    }
                                >

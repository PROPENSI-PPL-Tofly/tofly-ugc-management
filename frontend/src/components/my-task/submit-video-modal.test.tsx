...
describe("SubmitVideoModal", () => {
  ...
  it("shows a field error and keeps the modal open when validation fails", async () => {
    const onSubmitted = vi.fn();
    const onClose = vi.fn();
    ...
    mockSubmitVideo.mockResolvedValue({
      ...
      errors: {
        link: "Link video harus berupa URL http atau https",
      },
    });
    ...
    expect(
      await screen.findByText(
        "Link video harus berupa URL http atau https",
      ),
    ).toBeInTheDocument();
